...
def main():
    ...
    try:
	    ...
	    #Set the Target DP to S1DP0
            ...
            print('>show running tunnel flow nexthop\n')
            ...
            for c_id in context_id_list:
                print('>show running tunnel flow context ',c_id)
            ...
            print('>show session all filter destination-port 4501')
            ...
            print('>show session all filter destination ',destination_of_session)
	    ...
	    #Print the output of the "show running tunnel flow context with the context id"
            ...
            #Print the output of "show session all filter destination <Entered destination>"
            print('>show session all filter destination ',destination_of_session)
            output=net_connect.send_command("show session all filter destination %s\n" %destination_of_session)
            print(output)
